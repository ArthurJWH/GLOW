...
class MainWindow(QMainWindow):
    ...
    def info(self) -> None:
        ...
        with open(resource_path("docs", "info_lite.md"), "r", encoding="utf-8") as f:
            md_text = f.read()
...
class GLOWgui(QWidget):
    ...
    def __init__(self) -> None:
        ...
        title = QLabel()
        pixmap = QPixmap(resource_path("assets", "img", "title.png"))
        ...
        QCoreApplication.setApplicationName("GLOW Lite")
        appdata = Path(
    ...
    def generate_gcode(self) -> None:
        if self.filedrop.file_path is None:
            ...
            if "rpm_1" not in csv_data and "rpm_2" not in csv_data:
                ...
                valid = False
            if "width" not in csv_data and shape == "Cube":
                self.display.addItem("There is no 'width' column in the CSV file")
                valid = False
